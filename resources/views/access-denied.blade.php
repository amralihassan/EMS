              ...
              <div class="card-content">
                <div class="row py-2">
                  <div class="col-12 col-sm-6 col-md-6">
                    <a href="{{route('dashboard')}}" class="btn btn-primary btn-block"><i class="ft-home"></i> Back to Home</a>
                  </div>
                  <div class="col-12 col-sm-6 col-md-6">
                    <a href="{{route('logout')}}" class="btn btn-danger btn-block"><i class="ft-power"></i>  {{ trans('local.logout') }}</a>
                  </div>
                </div>
              </div>
            </div>
