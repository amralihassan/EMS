...
@section('title', trans('student::local.edit_language'))
@section('sidebar')
...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
      <h3 class="content-header-title">{{trans('student::local.edit_language')}}</h3>
      <div class="row breadcrumbs-top">
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{trans('student::local.edit_language')}}
            </li>
          </ol>
        </div>
      </div>
        ...
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form" action="{{route('languages.update',$language->id)}}" method="POST">
              ...
              @method('PUT')
                <div class="form-body">
                    @include('student::settings.languages.includes._form')
                </div>
