...
@section('title', trans('student::local.add_nationality'))
@section('sidebar')
...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
      <h3 class="content-header-title">{{trans('student::local.add_nationality')}}</h3>
      <div class="row breadcrumbs-top">
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{trans('student::local.add_nationality')}}
            </li>
          </ol>
        </div>
      </div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form" action="{{route('nationalities.store')}}" method="POST">
              @csrf
                <div class="form-body">
                    @include('student::settings.nationalities.includes._form')
                </div>
