          ...
          <div class="card-body">
            <form class="form" action="{{route('fathers.update',$father->id)}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                              ...
                              <select name="father_id_type" class="form-control">
                                  ...
                                  <option {{old('father_id_type',$father->father_id_type) == trans('student::local.national_id') ||
                                  old('father_id_type',$father->father_id_type) == 'national_id'
                                  ?'selected':''}} value="national_id">{{ trans('student::local.national_id') }}</option>
                                  <option {{old('father_id_type',$father->father_id_type) == trans('student::local.passport') ||
                                  old('father_id_type',$father->father_id_type) == 'passport'
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="number" min="0" class="form-control " value="{{old('father_id_number',$father->father_id_number)}}" placeholder="{{ trans('student::local.id_number') }}"
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                              ...
                              <select name="father_religion" class="form-control">
                                  <option value="">{{ trans('student::local.select') }}</option>
                                  <option {{old('father_religion',$father->father_religion) == 'muslim' ?'selected':''}} value="muslim">{{ trans('student::local.muslim') }}</option>
                                  <option {{old('father_religion',$father->father_religion) == 'non_muslim' ?'selected':''}} value="non_muslim">{{ trans('student::local.non_muslim') }}</option>
                              </select>
                              <span class="red">{{ trans('student::local.requried') }}</span>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                              ...
                              <select name="father_nationality_id" class="form-control ">
                                  ...
                                  @foreach ($nationalities as $nationality)
                                      <option {{old('father_nationality_id',$father->father_nationality_id) == $nationality->id ?'selected' : ''}} value="{{$nationality->id}}">{{$nationality->male_nationality}}</option>
                                  @endforeach
                              </select>
                              <span class="red">{{ trans('student::local.requried') }}</span>
                            </div>
                    ...
                    <div class="row">
                      <div class="col-lg-3 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control " value="{{old('father_job',$father->father_job)}}" placeholder="{{ trans('student::local.job') }}"
                              name="father_job">
                              <span class="red">{{ trans('student::local.requried') }}</span>
                          </div>
                      </div>
                      <div class="col-lg-3 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control " value="{{old('father_qualification',$father->father_qualification)}}" placeholder="{{ trans('student::local.qualification') }}"
                      ...
                      <div class="col-lg-3 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control " value="{{old('father_facebook',$father->father_facebook)}}" placeholder="{{ trans('student::local.facebook') }}"
                      ...
                      <div class="col-lg-3 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control " value="{{old('father_whatsapp_number',$father->father_whatsapp_number)}}" placeholder="{{ trans('student::local.whatsapp_number') }}"
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="number" min="0" class="form-control " value="{{old('father_home_phone',$father->father_home_phone)}}" placeholder="{{ trans('student::local.home_phone') }}"
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="number" min="0" class="form-control " value="{{old('father_mobile1',$father->father_mobile1)}}" placeholder="{{ trans('student::local.mobile1') }}"
                                name="father_mobile1">
                                <span class="red">{{ trans('student::local.requried') }}</span>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="number" min="0" class="form-control " value="{{old('father_mobile2',$father->father_mobile2)}}" placeholder="{{ trans('student::local.mobile2') }}"
                                name="father_mobile2">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="email" class="form-control " value="{{old('father_email',$father->father_email)}}" placeholder="{{ trans('student::local.email') }}"
                                name="father_email">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="number" min="0" class="form-control " value="{{old('father_block_no',$father->father_block_no)}}" placeholder="{{ trans('student::local.block_no') }}"
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control " value="{{old('father_street_name',$father->father_street_name)}}" placeholder="{{ trans('student::local.street_name') }}"
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control " value="{{old('father_state',$father->father_state)}}" placeholder="{{ trans('student::local.state') }}"
                                name="father_state">
                                <span class="red">{{ trans('student::local.requried') }}</span>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control " value="{{old('father_government',$father->father_government)}}" placeholder="{{ trans('student::local.government') }}"
              ...
              <div class="form-actions">
                <button type="button" class="btn btn-warning mr-1" onclick="location.href='{{route('fathers.show',$father->id)}}';">
